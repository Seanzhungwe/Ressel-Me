...
import img2 from "../assets/images/img17.png";
import img3 from "../assets/images/img18.png";
import img4 from "../assets/images/Group 3.png";
import img5 from "../assets/images/img16.png";
      ...
      <div className="container-fluid outerTestmonial">
        <div className="row innerTestmonial">
          ...
          <div className="col-12 col-md-12 col-lg-8 col-xl-6 col-xxl-6 testimonialItem">
            <div>
              <div className="d-flex overflow-hidden" id="slider2" style={{ scrollBehavior: 'smooth' }}>
